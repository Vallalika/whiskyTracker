...
public class Whisky {
    ...
    @ManyToOne
    @JsonIgnoreProperties({"whiskies"}) // Match name to table name above
    @JoinColumn(name = "distillery_id", nullable = false) // distillery field can't be null in whiskies table
